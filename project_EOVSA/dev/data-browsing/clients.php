...
if(isset($_GET['query']) && $start_date && $total_day) {
    ...
    // $end_date = date("Y-m-d", strtotime($inc, strtotime($start_date)));
...
<div class="row">
    <div class="col-sm-4" align = "left">
        <!-- <hr> -->
        <div class="text-left"><a href="add.php" type="button" class="btn btn-success btn-md"><span class="fa fa-plus"></span> Add Log</a></div>
        <!-- <hr> -->
    </div>
